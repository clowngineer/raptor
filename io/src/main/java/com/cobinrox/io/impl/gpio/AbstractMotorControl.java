...
public abstract class AbstractMotorControl implements IMotorControl {
	...
	protected abstract void lowLevelMove(final String foreAft, final String leftRight)
		throws Throwable;
	protected abstract void lowLevelStop(final String foreAft, final String leftRight)
		throws Throwable;
	protected abstract void brakeAll() throws Throwable;
